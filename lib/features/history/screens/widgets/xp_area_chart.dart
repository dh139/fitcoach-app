...
class XpAreaChart extends StatelessWidget {
  final List<ChartDataPoint> data;
  const XpAreaChart({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    final yMax = maxY < 100 ? 200.0 : maxY * 1.15;
      ...
      dotData: FlDotData(
        ...
        getDotPainter: (spot, _, __, ___) =>
            FlDotCirclePainter(
              radius:      3,
              color:       spot.y > 0
                  ? AppColors.lime : Colors.transparent,
              strokeWidth: 0,
      ...
      belowBarData: BarAreaData(
        ...
        gradient: LinearGradient(
          colors: [
            ...
            AppColors.lime.withOpacity(0.0),
          ],
